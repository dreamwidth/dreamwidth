...
sub blocked_anon {
    ...
    my $message =
"You don't have permission to access $LJ::SITENAME. Please first <a href='$LJ::SITEROOT/login?skin=lynx'>log in</a>.";
...
sub trans {
    ...
    $apache_r->headers_out->{'Referrer-Policy'}        = 'strict-origin-when-cross-origin';
