...
sub render_body {
    ...
    $ret .=
          "<td><div class='highlight-box'><p class='tips-header'><strong>"
        . $class->ml('widget.linkslist.tips')
        . "</strong></p>";
    ...
    $ret .= "<li>" . $class->ml('widget.linkslist.about.hoverhead') . "</li></ul></div>";
    $ret .= "</td></tr></table>";
    ...
    $ret .=
        "<th>" . $class->ml('widget.linkslist.table.title') . "</th><td>&nbsp;</td></tr></thead>";
    ...
    foreach my $ct ( 1 .. $showlinks ) {
        ...
        if ( $ct >= $caplinks ) {
            $ret .= "</td></tr><tr><td colspan='2'>&nbsp;</td><td>"
                . LJ::Lang::ml('cprod.links.text3.v1');
        }
        $ret .= "</td></tr>";
