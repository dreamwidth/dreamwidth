...
@LJ::USER_TABLES = (
    ...
    "subs",                "ratelog",        "loginstall",      "sessions",
    "sessions_data",       "modlog",         "modblob",         "userproplite2",
    "links",               "userpropblob",   "clustertrack2",   "reluser2",
    "tempanonips",         "inviterecv",     "invitesent",      "memorable2",
    "memkeyword2",         "userkeywords",   "trust_groups",    "userpicmap2",
    "userpic2",            "s2stylelayers2", "s2compiled2",     "userlog",
    "logtags",             "logtagsrecent",  "logkwsum",        "usertags",
    "pendcomments",        "loginlog",       "active_user",     "bannotes",
    "notifyqueue",         "dbnotes",        "random_user_set", "poll2",
    "pollquestion2",       "pollitem2",      "pollresult2",     "pollsubmission2",
    "vgift_trans",         "embedcontent",   "usermsg",         "usermsgtext",
    "usermsgprop",         "notifyarchive",  "notifybookmarks", "embedcontent_preview",
    "logprop_history",     "import_status",  "externalaccount", "content_filters",
    "content_filter_data", "userpicmap3",    "media",           "collections",
    "collection_items",    "logslugs",       "media_versions",  "media_props",
);
