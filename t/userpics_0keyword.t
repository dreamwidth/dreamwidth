...
sub run_tests {
    ...
    # checking user of 0 keyword userpics in comments
    {
        ...
        ok( $new_keyword2_t3 eq "0keyword", "userpic 2 now has keyword: 0keyword - $new_keyword2_t3 : mapid $nmapid" );
        my $comment_keyword_t3 = $fake_comment_t3->userpic_kw;
        ok( $comment_keyword_t3 eq "0keyword", "comment has keyword 0keyword - $comment_keyword_t3" );
