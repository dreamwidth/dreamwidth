...
"http://i.cdn.turner.com/cnn/.element/apps/cvp/3.0/swf/cnn_416x234_embed.swf?context=embed&videoId=bestoftv/2012/09/05/exp-tsr-dem-platform-voice-vote.cnn"
    ...
    test_good_url("https://clips.twitch.tv/embed?clip=IncredulousAbstemiousFennelImGlitch");
    test_good_url("https://player.twitch.tv/?channel=dallas&parent=streamernews.example.com");
    test_good_url("https://player.twitch.tv/?video=v40464143&parent=streamernews.example.com");
    test_good_url("https://player.twitch.tv/?collection=abcDeF1ghIJ2kL");
