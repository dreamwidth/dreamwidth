...
my @pairs = map {
      $_->[0] =~ m!^//\.(.+)$! ? (
        [ "http://$1" , $_->[1] ], [ "https://$1", $_->[1] ],
        [ "http://www.$1" , $_->[1] ], [ "https://www.$1", $_->[1] ], )
    ...
    [ "http://username.fakejournal.com/data/rss_friends", "ljish://fakejournal.com/username/friends"],
    [ "http://username.fakejournal.com/data/atom_friends", "ljish://fakejournal.com/username/friends"],
    ...
    [ "//.blogger.com/feeds/0123456789/1234/comments/full", "blogger://0123456789/1234/comments/full" ],
