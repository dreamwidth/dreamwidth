...
note("-- community-to-unregistered");
{
    ...
    DW::RequestCache->remove( 'rel', $fromu->userid . "-" . $admin->userid . "-A" );
...
note("-- personal-to-community");
{
    ...
    DW::RequestCache->remove( 'rel', $tou->userid . "-" . $fromu->userid . "-A" );
...
note("-- two username swap personal <=> community ");
{
    ...
    # make admin of u
    LJ::set_rel( $comm, $u, "A" );
    DW::RequestCache->remove( 'rel', $comm->userid . "-" . $u->userid . "-A" );
...
note("-- two username swap personal <=> community (with malice)");
{
    ...
    DW::RequestCache->remove( 'rel', $comm->userid . "-" . $u2->userid . "-A" );
...
note("-- two username swap (community and community)");
{
    ...
    DW::RequestCache->remove( 'rel', $c1->userid . "-" . $admin->userid . "-A" );
    LJ::set_rel( $c2, $admin, "A" );
    DW::RequestCache->remove( 'rel', $c2->userid . "-" . $admin->userid . "-A" );
