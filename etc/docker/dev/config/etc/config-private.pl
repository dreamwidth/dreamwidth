...

{
    ...
    %DBINFO = (
        'master' => {    # master must be named 'master'
            'host'   => "localhost",
            'port'   => 3306,
            'user'   => 'root',         # CHANGETHIS if on Dreamhack to dh_username
            'pass'   => 'password',     # CHANGETHIS
            'dbname' => 'dw_global',    # CHANGETHIS if on Dreamhack to dreamhack_username
            'role'   => {
                'slow' => 1,
            },
        },
        'cluster01' => {                # master must be named 'master'
            'host'   => "localhost",
            'port'   => 3306,
            'user'   => 'root',            # CHANGETHIS if on Dreamhack to dh_username
            'pass'   => 'password',        # CHANGETHIS
            'dbname' => 'dw_cluster01',    # CHANGETHIS if on Dreamhack to dreamhack_username
            'role'   => {
                'cluster1' => 1,
            },
        },
    ...
    @THESCHWARTZ_DBS = (
        {
            ...
            ,    # CHANGETHIS if on Dreamhack to dreamhack_username instead of dw_schwartz
    ...
    @ALTERNATE_DOMAINS = ( 'ljsite.org', 'ljsite.net', 'ljsite.co.uk', 'ljsite.tld', );
