// Access-filter editor, extracted from editfilters.bml.
...
document.addEventListener("DOMContentLoaded", function () {
 ...
 function renameGroup ()
 {
     ...
     var newtext = document.fg["efg_set_"+item.value+"_name"].value;
     newtext = prompt(labels.rename, newtext);
 ...
 function deleteGroup ()
 {
     ...
     var conf = confirm(labels.delete);
     if (!conf) { return; }
 ...
 function newGroup ()
 {
     ...
     var gnum = i;
     var groupname = prompt(labels.newname, "");
    ...
    form.list_groups.addEventListener("change", groupClicked);
    var actions = {
        up: function () { moveGroup(-1); }, down: function () { moveGroup(1); },
        add: moveIn, remove: moveOut, create: newGroup, rename: renameGroup, delete: deleteGroup
    };
